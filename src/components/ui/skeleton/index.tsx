...
>(function Skeleton(
  ...
  const speedValue = Number(speed) || 2;
  const customTimingFunction = useRef(Easing.bezier(0.4, 0, 0.6, 1)).current;
  const fadeDuration = 0.6;
  const animationDuration = (fadeDuration * 10000) / speedValue;
  ...
  }, [animationDuration, customTimingFunction, isLoaded, pulseAnim]);
