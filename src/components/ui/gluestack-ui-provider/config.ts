...
export const config = {
  light: vars({
    ...
    '--color-primary-500': '255 176 32',
    '--color-primary-600': '224 154 23',
    '--color-primary-700': '208 140 18',
    ...
    /* Typography */
    '--color-typography-0': '11 11 15',
    '--color-typography-50': '245 245 245',
    '--color-typography-100': '229 229 229',
    '--color-typography-200': '219 219 220',
    '--color-typography-300': '212 212 212',
    '--color-typography-400': '163 163 163',
    '--color-typography-500': '181 181 190',
    '--color-typography-600': '115 115 115',
    '--color-typography-700': '82 82 82',
    '--color-typography-800': '64 64 64',
    '--color-typography-900': '245 245 247',
    ...
    /* Background */
    '--color-background-0': '11 11 15',
    '--color-background-50': '23 23 28',
    '--color-background-100': '31 31 38',
    '--color-background-200': '46 46 56',
    '--color-background-300': '46 46 56',
    ...
    /* Background Special */
    '--color-background-error': '255 77 77',
    '--color-background-warning': '255 176 32',
    '--color-background-success': '74 222 128',
    '--color-background-muted': '31 31 38',
    '--color-background-info': '255 176 32',

    /* Focus Ring Indicator  */
    '--color-indicator-primary': '255 176 32',
    '--color-indicator-info': '83 153 236',
    '--color-indicator-error': '255 77 77',
  }),
  dark: vars({
